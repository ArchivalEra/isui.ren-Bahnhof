...
- [2026-08-15 - stack] Reuse heart's stack: Preact 10 + Vite + TS +
  Rust/wasm ball engine.
...
| openlist-to-object-storage | research | open | - |
| song-wall-data-model | grilling | open | openlist-to-object-storage |
| site-structure-navigation | grilling | open | - |
| bahnhof-visual-direction | prototype | open | site-structure-navigation |
| heart-bahnhof-card | task | open | edgeone-subpath-binding |

## Not yet specified

- Bahnhof's **station visual aesthetic**: how the station/train metaphor
  visualizes (signage, timetable, track), what role the three balls play in
  the station (waiting passengers?) - focus after site structure settles.
- **Song-wall field granularity**: what "extensible variables" one song
  records (title/artist/source/link/why-to-listen/tags/status...), which
  go to object storage, which into local data files.
