// Variant B — "Departure board" v2: a LIVE electronic board.
// The board is a flat slab (1280 wide). Top: a fixed "now" row (current
// time + the next departure, highlighted). Below: rows AUTO-SCROLL
// upward, marquee-style, seamless loop — the way a real station board
// lives. Hover pauses; prefers-reduced-motion freezes it.
